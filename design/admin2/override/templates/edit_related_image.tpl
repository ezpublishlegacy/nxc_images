...
{if $attribute.content}
    ...
    {include uri='design:content/datatype/edit/ezobjectrelation_image_ajaxuploader.tpl' enabled=false()}
{else}
    ...
    {include uri='design:content/datatype/edit/ezobjectrelation_image_ajaxuploader.tpl' enabled=true()}
{/if}
</div>
<div class="right">
...
{include uri='design:content/datatype/edit/ezobjectrelation_image_ajax_search.tpl'}
</div>
{/case}
