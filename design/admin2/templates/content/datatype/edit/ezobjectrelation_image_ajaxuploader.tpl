{if ezmodule( 'ezjscore' )}
    ...
    {run-once}
    {ezscript_require( array( 'nxc_contentstructuremenu_dynamic.js', 'ezajaxuploader_nxcimages.js', 'ezjsc::yui3', 'ezjsc::yui3io', 'ezmodalwindow.js' ) )}
        ...
        YUI(YUI3_config).use('node', 'overlay', 'dom-base', 'io-ez', 'io-form', 'io-upload-iframe', 'json-parse', 'anim', function (Y) {
            Y.on('domready', function() {
                ...
                Y.all('.simple-relation-upload-new').each(function () {
                    ...
                    uploader = new eZAjaxUploaderNXCImages(win, conf, Y);
