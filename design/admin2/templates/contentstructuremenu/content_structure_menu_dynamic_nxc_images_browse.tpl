...
{/default}
    ...
    window.treeMenuBrowse = new ContentStructureMenuBrowse( params, i18n );
	jQuery( '#contentstructure-browse' ).append( jQuery( '<ul id="content_tree_menu_browse">' + treeMenuBrowse.generateEntry( rootNode, false, true ) + '<\/ul>' ) );
    window.treeMenuBrowse.load( false, rootNode.node_id, rootNode.modified_subnode );
{rdelim})();
</script>
