...
eZOEPopupUtils.bookmarksCallBack = function( bookmarkData )
{
    ...
    eZOEPopupUtils.browseCallBack( bookmarkData, 'bookmarks', function( tbody, mode, ed )
    {
    ...
    jQuery( '#bookmarks_box_prev tbody a[href^="JavaScript"]' ).each( function( i, element ) {
	$( this ).bind( 'click', function() {
		//console.log( window.treeMenuBrowse );
		//console.log( $( this ).attr( 'href' ).match(/JavaScript:eZOEPopupUtils.browse\(([0-9]*)\);/i)[1] );
	} );
    } );
};
